...
public class Movies implements Parcelable {
        ...
        public void writeToParcel(Parcel dest, int flags) {
                ...
                dest.writeString(descriptionIntro);
                ...
                dest.writeString(mediumScreenshotImage1);
                dest.writeString(mediumScreenshotImage2);
                dest.writeString(mediumScreenshotImage3);
                dest.writeString(largeScreenshotImage1);
                dest.writeString(largeScreenshotImage2);
                dest.writeString(largeScreenshotImage3);
                dest.writeString(dateUploaded);
                if (dateUploadedUnix == null) {
                        dest.writeByte((byte) 0);
                } else {
                        dest.writeByte((byte) 1);
                        dest.writeInt(dateUploadedUnix);
                }
        }
